...
from .keys import EvidentlyGenerativeMetrics

if TYPE_CHECKING:
    from ...client import RaiTraceClient

class EvidentlyProvider:
    """
    ...
    def submit(self, eval_metrics: Dict[str, Any], application_name: str, version: str = "1.0.0", use_case: str = "default"):
        ...
        try:
            eval_metrics = EvidentlyGenerativeMetrics(**eval_metrics).model_dump()
